    ...
    <SmallHeader name="Twitter API Bots" />
        ...
        <div class="container text-left">
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <h3>Introduction</h3>
                    <p class="lead mb-5">Using Node.js and the Twitter API I was able to set up two automated accounts. <a href="https://twitter.com/naturepictos" data-custom-cursor>Nature Pics</a> tweets a random nature picture that is taken from the Unsplash API and then sent to the Microsoft Azure Computer Vision REST API which generates an AI caption for the image. I then connect to the Twitter API and tweet out the image with the caption. <a href="https://twitter.com/Marvinsro0om" data-custom-cursor>Marvin</a> is connected to openAIs API to utilize chatGPT and tweets an ai generated tweet based on given prompts every hour.</p>
                    ...
                    <h3>AI Persona</h3>
                    <p class="lead mb-5">In order to fully commit to the AI account I figured I needed to create an artificial person to put a face behind the tweets. I took to <a href="https://generated.photos/" data-custom-cursor>Generated Photos</a> to generate a human based on a bunch of parameters and managed to generate one that I thought fit the part. </p>   
                </div>
            </div>
        </div>
