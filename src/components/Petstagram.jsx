    ...
    <SmallHeader name="Petstagram" />
        ...
        <div class="container text-left">
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <h3>Introduction</h3>
                    <p class="lead mb-5">Using Javascript and HTML/CSS I created a React.js app that is basically social media for pets! The app uses MongoDB to store all the users and posts so they can be saved and retrieved when needed. The backend uses express.js, node.js and jsonwebtoken to host a server that can be interacted with by the front end. </p>
                    <h3>Logging In</h3>
